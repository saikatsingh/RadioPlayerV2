...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player Bot** \nI Can Play Radio/Stream Music In Channels & Groups 24x7 Nonstop. Made ❤️ By @MoviZenX!"
HELP = """🏷️ **Need Help?** 🤔
__(Join @MoviZeniX For Support)__
...
async def start(client, message):
    buttons = [
        [
        InlineKeyboardButton('CHANNEL', url='https://t.me/MoviZenX'),
        InlineKeyboardButton('SUPPORT', url='https://t.me/MOVIZENiX'),
    ],
    [
        InlineKeyboardButton('Chat Room', url='https://t.me/mzx_Support'),
